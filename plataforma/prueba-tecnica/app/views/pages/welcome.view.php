<main class="w-full h-screen p-10 flex gap-32">
    <aside class="w-full max-w-[500px] flex flex-col gap-20">
        <header class="w-full flex flex-col gap-5">
            <h2 class="text-2xl font-bold">Tasky</h2>
        </header>
        <div class="space-y-6">
            <div class="space-y-2">
                <h1 class="text-4xl font-extrabold">Bienvenido a Tasky</h1>
                <p class="text-lg">
                    Tasky es una aplicación de gestión de tareas que te ayudará a organizar tu vida. Para empezar, por favor, autentícate.
                </p>
            </div>
            <form action="/auth/login" method="POST" class="space-y-5">
                ...
                <fieldset class="pt-3 space-y-5">
                    ...
                    <p class="text-base-content/80 text-lg">¿No tienes cuenta? <a href="/page/register" class="text-primary hover:underline">Regístrate</a></p>
                </fieldset>
            </form>
        </div>
    </aside>
